                    ...
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                            ...
                            //get details of all cars
                                    $ret="SELECT * FROM crms_bookings WHERE b_status = 'Approved' ORDER BY RAND() "; 
                            ...
                            ?>
                                ...
                                <td>
                                    ...
                                    //If Approved show in Green If its Paid
                                        ...
                                        {
                                            $perc = ($row->amount_due_pay / $row->revenue) * 100;
                                            echo '<span class="badge badge-danger">';  echo $perc . '% Paid'; '</span>';
                                        }
                                    ?>
                                </td>
                                <td>
